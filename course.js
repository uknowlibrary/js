...
const load = setTimeout(loading,1000);

function loading(){

document.getElementById("internaloutput").innerHTML="<p style='color:white;'>LOADING...</p>";
document.getElementById("srch").innerHTML="<p id='myInput' style='color:white;position:fixed;left:100px;'>LOADING...</p>";

const cs = setTimeout(mycourse,3000);
}

function mycourse(){
document.getElementById("srch").innerHTML="<input type='text' id='myInput' onkeyup='mycourseselect()' placeholder='Search for course..' title='Type in a name' style='max-width:200px;height:50px;border-radius:26px 40px;'>";
